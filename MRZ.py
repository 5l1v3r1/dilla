...
def usage():
	print '---------------------------------------------------'
	print 'to attack:'
        print '#Windows: misterZuck.py http://www.israelfuck.com'
        print '#Linux: python misterD.py http://www.israelfuck.com'
	print "\a"
print \
"""                          
              /$$$$$$$$ /$$$$$$   /$$$$$$         /$$$$$$    /$$      /$$$$$$  /$$   /$$
   |__  $$__//$$__  $$ /$$__  $$       /$$__  $$  | $$     /$$__  $$| $$  /$$/
      ...
      | $$   /$$  \ $$ /$$  \ $$      | $$  | $$  | $$ /$$| $$    $$| $$\  $$ 
      | $$  |  $$$$$$/|  $$$$$$/      | $$  | $$  |  $$$$/|  $$$$$$/| $$ \  $$
      |__/   \______/  \______/       |__/  |__/   \___/   \______/ |__/  \__/
       _______________________________________________________________[MISTER_D]
   ...
   |     /$$   /$$ /$$$$$$$$ /$$$$$$$$ /$$$$$$$    |
              ...
              |    | $$  | $$   | $$      | $$   | $$         |
              |    |__/  |__/   |__/      |__/   |__/         |
              |_____________________________________[MISTER_ZUCKER04]__|
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print 'MISTER_D > A GREAT DUET ATTACK < MISTER ZUCKER_04'
			code=500
	...
	def run(self):
		...
		while flag==0:
			if (previous+100<request_counter) & (previous<>request_counter):
				print "%ddos dulu coy" % (request_counter)
				previous=request_counter
		if flag==2:
			print "\n -mmb Hits are acces"
